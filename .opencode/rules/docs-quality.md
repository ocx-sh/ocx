<!-- generated by grim from ghcr.io/ocx-sh/lore/docs-quality@sha256:cb951c2acc1c3b4c3e88989f72b664ff518c933e1805c535ec628be41d058bd3; edits will be overwritten -->
> Applies only when working on files matching `**/*.md`, `**/*.mdx`, `**/*.rst`, `**/*.adoc`, `**/*.asciidoc`, `**/mkdocs.yml`, `**/book.toml`, `**/.vitepress/config.*`, `**/docusaurus.config.*`, `**/antora.yml`.
