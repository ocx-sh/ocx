...
- `ocx verify` — keyless Sigstore verification of a target manifest against a user-specified identity and OIDC issuer. Verifies the Fulcio certificate chain, Rekor SET, and signature over the subject digest. *(verify)*
