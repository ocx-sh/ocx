...
<Terminal src="/casts/in-depth/shell-integration/adding-a-package.cast" title="Adding a tool applies it at the next prompt" collapsed />

<Terminal src="/casts/in-depth/shell-integration/cd-into-project.cast" title="Landing inside a consented project" collapsed />

<Terminal src="/casts/in-depth/shell-integration/cd-out-of-project.cast" title="Leaving a project takes its tools back off PATH" collapsed />
