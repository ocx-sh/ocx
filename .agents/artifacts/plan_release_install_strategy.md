...
| # | Increment | File | Status |
|---|-----------|------|--------|
| 07 | install.sh — Unix/macOS bootstrap | [inc_07_install_sh.md](increments/release_install/inc_07_install_sh.md) | Not Started |
| 08 | install.ps1 — Windows PowerShell bootstrap | [inc_08_install_ps1.md](increments/release_install/inc_08_install_ps1.md) | Not Started |
...
| # | Increment | File | Status |
|---|-----------|------|--------|
| 14 | Installation page (website) + README update | [inc_14_installation_docs.md](increments/release_install/inc_14_installation_docs.md) | Not Started |
...
| # | Increment | File | Status |
|---|-----------|------|--------|
| 16 | Update check notification + OCX_NO_UPDATE_CHECK | [inc_16_update_check.md](increments/release_install/inc_16_update_check.md) | Not Started |
