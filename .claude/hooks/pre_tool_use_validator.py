...
# Files generated by external tools — must not be edited directly
_GENERATED_FILES: dict[str, str] = {
    ".github/workflows/release.yml": (
        "This file is generated by cargo-dist from dist-workspace.toml.\n"
        "Edit dist-workspace.toml, then run: dist generate-ci\n"
...
def is_generated(rel_path: str) -> str | None:
    """Return the guidance message if rel_path is a generated file, else None."""
...
def main() -> None:
    ...
    # --- Generated files ---
    generated_msg = is_generated(rel_path)
    if generated_msg:
        hook_utils.output_json(
            hook_utils.deny(
                f"Cannot modify generated file: {rel_path}.\n{generated_msg}"
            )
        )
        sys.exit(0)
