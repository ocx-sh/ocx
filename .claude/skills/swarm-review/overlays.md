...
Controls model for `worker-doc-reviewer` when it launches (Stage 2 at tier=high/max when doc triggers match). Single-pass narrow-scope doc audit — see `.claude/artifacts/research_model_capability_matrix.md`.
