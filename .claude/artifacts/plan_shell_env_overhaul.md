...
**All 42 resolutions of [`adr_shell_env_addenda.md`](./adr_shell_env_addenda.md) are reachable
...
in two rows names a seam already declared in §7.2's coverage note. **A-39…A-42 were added during
review rounds 2–3**, each recording a shipped behaviour change the record had not caught up with;
they land inside existing work packages and add none.
