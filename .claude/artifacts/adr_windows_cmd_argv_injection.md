...
- **CVE-2025-61787** — [Deno BatBadBut class](https://github.com/advisories/GHSA-g5qm-m9q7-jmrq), CVSS 8.1, 2025-06-13. Deno failed to sanitize arguments when spawning `.bat`/`.cmd` processes on Windows, enabling command injection via the same `%*`-expansion vector. Confirms the BatBadBut class remains an active finding surface in 2025, not a closed historical issue. Cross-ref: [GHSA-g5qm-m9q7-jmrq](https://github.com/advisories/GHSA-g5qm-m9q7-jmrq).
