> **Note (2026-05-03):** This research informed Option 4 of the original locking strategy ADR, now superseded by [`adr_project_lock_inplace.md`](./adr_project_lock_inplace.md). The body is preserved for historical context.
