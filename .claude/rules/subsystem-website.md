...
| `src/public/schemas/{metadata,config,project,project-lock,patch}/v*.json` | **Generated** — JSON schemas from `ocx_schema` crate (`patch` = `ocx patch publish --descriptor-file` format) |
