...
| `oci/verify/trust_root.rs` | Trust-root loading: Fulcio CA PEM, Sigstore `TrustedRoot` JSON (`--tuf-root`, pinned Rekor key), cache rebuild; public-good root over TUF (`SigstoreTrustRoot`) |
