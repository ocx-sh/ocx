...
2. **Phase 2 (sequential `cmds:`)**: `rust:license:check`, `rust:license:deps`, `rust:license:notice:check`, `rust:deps:inventory`, `rust:lint:ratchet`, `rust:doc:ratchet`, `rust:build`, `rust:test:floor`, `rust:test:unit`, `rust:test:ceiling`, `rust:test:ceiling:self-test`, `rust:test:duration`, `rust:test:duration:self-test`, `rust:test:doc`, `test:parallel`
