...
2. **Phase 2 (sequential `cmds:`)**: `rust:license:check`, `rust:license:deps`, `rust:license:notice:check`, `scripts:suite-census`, `scripts:dead-path-sweep`, `rust:lint:ratchet`, `rust:doc:ratchet`, `rust:build`, `bazel:build:nobuild`, `bazel:build:drift`, `bazel:tag:guard`, `bazel:lint`, `bazel:mod:check`, `bazel:test:unit`, `rust:test:duration`, `rust:test:doc`, `bazel:test:accept`
