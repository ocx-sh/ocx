...
///   preserving the full [`ocx_oci::client::ClientError`] source chain.
...
/// [`ocx_oci::client::Client::fetch_single_layer_artifact`] onto the patch
...
/// [`ocx_oci::client::error::ArtifactFetchError::classify`].
