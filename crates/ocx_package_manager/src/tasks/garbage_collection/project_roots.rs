...
//! symlinks; the source is [`ocx_project::registry::ProjectRegistry::live_projects`]
...
/// live project directory from [`ocx_project::registry::ProjectRegistry::live_projects`]
