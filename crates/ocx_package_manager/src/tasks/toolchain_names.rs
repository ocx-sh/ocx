...
mod tests {
    ...
    use ocx_package::metadata::{Binaries, EntrypointName};
    ...
    /// source-shape guard because the `log` crate's bare facade has no capture
    /// facility in this codebase (precedent: `project/registry.rs`'s
