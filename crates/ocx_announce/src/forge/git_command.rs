...
///
/// Deliberately **not** [`ocx_package::version::Version`]. That type
...
/// ([`ocx_util::env::var`]); the child's own `PATH` comes from
...
/// [`Env::new`] bypasses `ocx_config::env`'s test seam entirely (it reads
