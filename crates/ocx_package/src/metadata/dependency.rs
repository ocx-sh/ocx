...
mod tests {
    ...
    fn make_digest() -> ocx_oci::Digest {
        ocx_oci::Digest::Sha256(sha256_hex())
    }
    ...
    fn bundle_without_dependencies_deserializes() {
        ...
        let metadata: crate::metadata::Metadata = serde_json::from_str(json).unwrap();
    ...
    fn bundle_with_dependencies_roundtrip() {
        ...
        let metadata2: crate::metadata::Metadata = serde_json::from_str(&reserialized).unwrap();
