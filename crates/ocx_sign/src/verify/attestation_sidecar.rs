...
use super::tlog;
use crate::attest::dsse::{DsseEnvelope, pae};
use crate::attest::predicate::PredicateType;
use crate::attest::{DSSE_PAYLOAD_TYPE, MAX_ATTESTATION_CANDIDATES, MAX_ATTESTATION_ENVELOPE_BYTES};
...
mod tests {
    ...
    use ocx_oci::referrer::media_types::{ANNOTATION_COSIGN_BUNDLE, ANNOTATION_COSIGN_CERTIFICATE};
    use ocx_trust::{CompiledKeyless, CompiledPolicy, IdentityRule, PolicyBackend};
    ...
    fn gate<'a>(
        ...
        SidecarVerification {
            ...
            rekor_keys: crate::verify::pipeline::RekorKeyMemo::default(),
        }
    }
