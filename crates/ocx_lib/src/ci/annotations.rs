...
//!
//! Every variable is read through [`crate::env::var`] — the *runtime* reader.
...
use crate::oci::annotations::{CREATED, REVISION, SOURCE, VERSION};
use crate::oci::referrer::manifest::{bundle_created, pinned_instant};
...
fn pipeline_created_at() -> Option<chrono::DateTime<chrono::Utc>> {
    ...
    match chrono::DateTime::parse_from_rfc3339(&raw) {
        ...
        Err(_) => {
            ...
            crate::log::warn!("ignoring malformed CI_PIPELINE_CREATED_AT; stamping the wall clock instead");
            None
        }
    }
}
...
mod tests {
    use super::*;
    use crate::test::env::{self, EnvLock};
