...
mod firewall_tests {
    ...
    // appear OUTSIDE this firewall directory (`crates/ocx_lib/src/script/`).
    // This locks the engine swap to a single directory.
    ...
    fn is_allowed(path: &Path) -> bool {
        ...
        s.contains("/ocx_lib/src/script/") || s.ends_with("/ocx_lib/src/script.rs")
    }
