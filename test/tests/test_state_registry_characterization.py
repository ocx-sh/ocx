...
SETUPS (recordings/setups.py):
  ...
  signing            — exercised by recordings suite (signing.sh)
...
1. The SETUPS registry keys (every canonical name must be present).
